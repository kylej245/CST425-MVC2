...
<body>
<br/>
<jsp:useBean id="bookDAO" class="edu.asupoly.cst425.t6mvc2.service.BookDAO" scope="request" />

Please the following information:
<jsp:useBean id="user" class="edu.asupoly.cst425.t6mvc2.model.User" scope="session" />
